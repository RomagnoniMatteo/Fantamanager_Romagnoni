package com.matteoromagnoni.fantamanager.FootballField;
...
public class Field extends View
{
    ...
    private void init()
    {
        ...
        paintDarkerGrass.setColor(getResources().getColor(R.color.fantasyGreenDark));
        paintDarkerGrass.setStyle(Paint.Style.FILL);

        paintGrass = new Paint();
        paintGrass.setAntiAlias(true);
        paintGrass.setColor(getResources().getColor(R.color.fantasyGreenDarksoft));

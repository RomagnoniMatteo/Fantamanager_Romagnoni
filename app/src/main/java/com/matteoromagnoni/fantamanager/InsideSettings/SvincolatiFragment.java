...
public class SvincolatiFragment extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            SvincolatiItem searchPlayerItem = new SvincolatiItem(1989, "Badelj", "Genoa", "C");
    ...
    public void openHome() {
        Intent intent = new Intent(SvincolatiFragment.this, Home.class);
